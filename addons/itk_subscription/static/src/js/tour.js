odoo.define('itk_subscription.tour', function(require) {
"use strict";
...
tour.register('itk_subscription_tour', {
	url: "/web",
}, [tour.STEPS.MENU_MORE, {
	trigger: '.o_app[data-menu-xmlid="itk_subscription.menu_sale_subscription_root"], .oe_menu_toggler[data-menu-xmlid="itk_subscription.menu_sale_subscription_root"]',
	content: _t('Want recurring billing via subscription management ? Get started by clicking here'),
	position: 'bottom',
},
{
    trigger: '.dropdown-toggle[data-menu-xmlid="itk_subscription.menu_sale_subscription_config"]',
    content: _t('Configure your subscription templates here'),
    position: 'bottom',},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="itk_subscription.menu_template_of_subscription"]',
...
{
    trigger: '.dropdown-toggle[data-menu-xmlid="itk_subscription.menu_sale_subscription"]',
    content: _t('Let\'s go to the catalog to create our first subscription product'),
    position: 'bottom',
},
{
    trigger: '.o_menu_entry_lvl_2[data-menu-xmlid="itk_subscription.menu_sale_subscription_product"]',
